...
__all__ = [
    'DISPID_SPPParent', 'SP_VISEME_9', 'SGSDisabled', 'SPPS_Function',
    'DISPID_SLPType', 'SRTReSent', 'SPEI_VOICE_CHANGE', 'SPSHT_EMAIL',
    'DISPID_SOTDisplayUI', 'SVEAllEvents', 'DISPID_SRRTimes',
    'DISPID_SRGDictationLoad', 'SpNullPhoneConverter',
    'DISPID_SPIStartTime', 'SPAUDIOBUFFERINFO', 'DISPID_SVVoice',
    'DISPIDSPTSI_SelectionLength', 'SDKLLocalMachine',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRGDictationUnload',
    'SAFT24kHz16BitStereo', 'SRTSMLTimeout', 'DISPID_SVSVisemeId',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechRecoGrammar', 'ISpDataKey',
    'eLEXTYPE_PRIVATE5', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SVEPhoneme', 'SPSVerb', 'SPFILEMODE', 'ISpPhrase',
    'DISPID_SRCVoice', 'SVEWordBoundary', 'SpeechDataKeyLocation',
    'SSTTWildcard', 'DISPID_SPAsCount', 'DISPID_SpeechRecoContext',
    'SGRSTTWord', 'SPEI_RESERVED1', 'SPEI_RESERVED5', 'SVPNormal',
    'DISPID_SRCCreateResultFromMemory', 'SpeechVoicePriority',
    'DISPID_SGRAttributes', 'DISPID_SRRGetXMLResult',
    'DISPID_SVEViseme', 'DISPID_SLGetWords', 'SpeechTokenValueCLSID',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechCustomStream', 'SECFIgnoreKanaType',
    'DISPID_SpeechPhraseAlternate', 'SPXRO_Alternates_SML',
    'SpeechLoadOption', 'DISPID_SPEDisplayText', 'LONG_PTR',
    'DISPID_SMSALineId', 'DISPID_SRCRetainedAudio',
    'eLEXTYPE_RESERVED8', 'SRERecoOtherContext',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPPS_Unknown', 'DISPID_SAStatus',
    'SPVISEMES', 'SVP_10', 'SPINTERFERENCE_NONE',
    'DISPID_SRCEInterference', 'SASClosed', 'DISPID_SPPs_NewEnum',
    'SAFT11kHz8BitStereo', 'DISPID_SGRAddResource',
    'SpeechRetainedAudioOptions', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SOTDataKey', 'DISPID_SPAs_NewEnum', 'SVESentenceBoundary',
    'SPEVENT', 'SPPARTOFSPEECH', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPRuleName', 'DISPID_SRRTLength',
    ...
    'DISPID_SRGState', 'eLEXTYPE_PRIVATE18',
    'ISpeechRecognizerStatus', 'SLTUser', 'DISPID_SDKGetBinaryValue',
    'DISPID_SLPsCount', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechObjectTokenCategory',
    'SpeechAddRemoveWord', 'DISPID_SVEBookmark', 'ISpStreamFormat',
    'ISpRecoContext', 'SGDisplay', 'DISPID_SGRSRule',
    'IInternetSecurityMgrSite', 'DISPID_SPRuleChildren',
    'DISPID_SLPPhoneIds', 'ISpeechRecoResultTimes',
    'SpSharedRecognizer', 'SPPHRASERULE', 'DISPID_SRCBookmark',
    'SAFT32kHz16BitMono', 'SPBO_PAUSE', 'SREFalseRecognition',
    'SREStateChange', 'DISPID_SGRSTNextState', 'SPPS_Modifier',
    'SPCT_SUB_COMMAND', 'eLEXTYPE_APP', 'IEnumSpObjectTokens',
    'DISPID_SpeechMMSysAudio', 'SAFTGSM610_44kHzMono',
    'ISpRecoGrammar', 'SREPropertyNumChange',
    'DISPID_SPISaveToMemory', 'SpeechCategoryRecoProfiles',
    'DISPID_SMSSetData', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVSPhonemeId', 'DISPID_SOTCategory', 'SPPS_RESERVED2',
    'DISPID_SRStatus', 'SPSMF_SRGS_SAPIPROPERTIES', 'SRAImport',
    'SPFM_CREATE', 'IEnumString', 'SpeechDictationTopicSpelling',
    'SpCustomStream', 'ISpLexicon', 'DISPID_SDKGetStringValue',
    'SpeechBookmarkOptions', 'SLOStatic',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRState',
    'SREStreamStart', 'ISpMMSysAudio', 'SPSHORTCUTPAIR',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SFSClose',
    'ISpeechPhraseElement', 'SPINTERFERENCE_NOSIGNAL',
    'SSSPTRelativeToEnd', 'SRSEDone', 'SPGS_ENABLED',
    'eLEXTYPE_PRIVATE16', 'DISPID_SLRemovePronunciation', 'SVP_14',
    'DISPID_SOTMatchesAttributes', 'DISPID_SVSInputSentenceLength',
    'DISPID_SPACommit', 'SpeechCategoryAudioIn',
    'DISPID_SPIProperties', 'SAFT22kHz16BitStereo', 'SAFTText',
    'SVSFUnusedFlags', 'DISPID_SRCEPropertyNumberChange', 'SVP_7',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SRSInactive',
    'DISPID_SPRuleEngineConfidence', 'SSSPTRelativeToStart',
    'ISpNotifyTranslator', 'DISPID_SGRSTRule', 'SRSInactiveWithPurge',
    'SPEI_SOUND_END', 'SPSHT_NotOverriden',
    'ISpeechObjectTokenCategory', 'SPXRO_SML', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVGetVoices', 'ISpPhraseAlt', 'ISpRecognizer',
    'SPTEXTSELECTIONINFO', 'SP_VISEME_17', 'SECLowConfidence',
    'SLTApp', 'SPINTERFERENCE', 'ISpRecoGrammar2', 'DISPID_SBSWrite',
    'SpResourceManager', 'SPWF_INPUT', 'SpeechVoiceSpeakFlags',
    'DISPID_SRRGetXMLErrorInfo', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SABIEventBias', 'ISpeechPhraseAlternate',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPRDisplayAttributes',
    'SVSFParseSsml', 'SAFT16kHz16BitStereo', 'SPWT_DISPLAY',
    'SPPS_RESERVED3', 'DISPID_SVSLastBookmark', 'SPFM_NUM_MODES',
    'SDTAudio', 'DISPID_SVVolume', 'DISPID_SRSCurrentStreamNumber',
    'Speech_Default_Weight', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVGetAudioInputs', 'SpeechRecognitionType',
    'ISpeechLexiconPronunciation', 'SpeechDiscardType', 'SP_VISEME_4',
    'SREHypothesis', 'SpeechCategoryAudioOut',
    'DISPID_SPERetainedSizeBytes', 'ISpeechPhraseProperty',
    'SPEI_REQUEST_UI', 'DISPID_SPRuleNumberOfElements',
    'SPEI_HYPOTHESIS', 'SPSNoun', 'ISpeechVoice', 'DISPID_SLWsCount',
    'SP_VISEME_8', 'SFTSREngine', 'SpeechVisemeFeature',
    'DISPID_SVAudioOutput', 'ISpeechLexiconWords', 'SPBO_NONE',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPAsItem',
    'SPEI_RESERVED2', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SLGetGenerationChange', 'ISpeechCustomStream',
    'DISPID_SOTRemove', 'SVEPrivate', 'DISPID_SPELexicalForm',
    'SREAdaptation', 'DISPID_SPEDisplayAttributes', 'SP_VISEME_21',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE13',
    'SAFTGSM610_11kHzMono', 'SDA_Two_Trailing_Spaces', 'SVF_None',
    'DISPID_SRCSetAdaptationData', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRIsShared', 'DISPID_SVAudioOutputStream',
    'SpeechCategoryAppLexicons', 'SpMMAudioIn',
    'DISPID_SLWPronunciations', 'SAFT11kHz8BitMono', 'SPEI_MAX_SR',
    'SPFM_OPEN_READWRITE', 'DISPID_SVStatus', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPPConfidence', 'SPPS_Verb', 'SVSFNLPMask',
    'ISpeechGrammarRule', 'SpMemoryStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpeechTextSelectionInformation', 'SpeechStreamSeekPositionType',
    'eLEXTYPE_RESERVED9', 'SRTStandard', 'SGDSActiveWithAutoPause',
    'SPEVENTENUM', 'DISPID_SVEventInterests', 'DISPID_SRRAlternates',
    'SAFTADPCM_44kHzMono', 'SAFT16kHz8BitMono', 'SWTDeleted',
    'DISPID_SASNonBlockingIO', 'SPVOICESTATUS', 'DISPID_SDKDeleteKey',
    'SpeechTokenContext', 'DISPID_SWFESamplesPerSec',
    'DISPID_SADefaultFormat', 'DISPID_SpeechDataKey',
    'DISPID_SRRDiscardResultInfo', 'SPRECOSTATE',
    'SVSFPurgeBeforeSpeak', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVPAlert', 'DISPID_SRRAudio',
    'SVF_Stressed', 'DISPID_SPRFirstElement',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFIsFilename',
    'DISPID_SpeechGrammarRules', 'DISPID_SASState',
    'DISPID_SOTCDefault', 'DISPID_SVPriority', 'SVP_17',
    'SPEI_RESERVED6', 'SPAR_High', 'DISPID_SpeechPhraseAlternates',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SAFT12kHz8BitMono',
    'SAFT48kHz8BitStereo', 'SRTEmulated', 'DISPIDSPRG',
    'ISpeechObjectTokens', 'DISPID_SRCEAdaptation',
    'SDA_No_Trailing_Space', 'DISPID_SPEPronunciation',
    'STCInprocHandler', 'DISPID_SWFEBitsPerSample',
    'ISpeechAudioFormat', 'DISPID_SpeechPhraseRules',
    'DISPID_SpeechRecognizerStatus', 'ISpeechRecoContext',
    'DISPID_SPRuleId', 'SPAUDIOSTATUS', 'SECFNoSpecialChars',
    'SPEI_PHONEME', 'SWPKnownWordPronounceable', 'SVEPhoneme',
    'SVSFIsNotXML', 'ISpeechPhraseInfo',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SGRsCount',
    'DISPID_SRGetPropertyString', 'SpObjectTokenCategory',
    'DISPID_SVPause', 'DISPID_SRDisplayUI', 'SpObjectToken',
    'SPINTERFERENCE_NOISE', 'SRERequestUI', 'DISPID_SPPId',
    'SpeechMicTraining', 'DISPID_SOTGetAttribute', 'SPCATEGORYTYPE',
    'DISPID_SLWLangId', 'DISPID_SOTCGetDataKey', 'SPAO_RETAIN_AUDIO',
    ...
    'DISPID_SOTIsUISupported', 'SASRun', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRAudioInput', 'DISPID_SRRAudioFormat', 'SPSFunction',
    'ISpObjectToken', 'SpInProcRecoContext',
    'DISPID_SpeechRecoResult2', 'DISPID_SAFGuid',
    'SpeechSpecialTransitionType', 'DISPID_SPRNumberOfElements',
    'SPCT_DICTATION', 'eLEXTYPE_VENDORLEXICON', 'ISpeechLexiconWord',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPAR_Low',
    'DISPID_SWFEChannels', 'DISPID_SPEAudioStreamOffset',
    'tagSPTEXTSELECTIONINFO', 'SP_VISEME_16', 'DISPID_SRProfile',
    'DISPID_SVGetAudioOutputs', 'SpPhoneConverter',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPWORDTYPE',
    'SSFMOpenReadWrite', 'DISPID_SpeechRecoResult',
    'DISPID_SRRPhraseInfo', 'ISpObjectTokenCategory',
    'DISPID_SPPsItem', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRCEBookmark', 'DISPID_SRRSpeakAudio',
    'SpeechRegistryLocalMachineRoot', 'SpStream',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechAudioFormatType', 'SVPOver',
    'SPWT_LEXICAL', 'DISPID_SPEs_NewEnum', 'SVSFlagsAsync',
    'DISPID_SpeechAudioBufferInfo', 'SPSEMANTICERRORINFO',
    'SPRECOGNIZERSTATUS', 'SRARoot', 'DISPIDSPTSI_ActiveLength',
    'STSF_AppData', 'SPEI_VISEME', 'DISPID_SGRSTransitions',
    'ISpeechPhraseProperties',
    'DISPID_SLRemovePronunciationByPhoneIds', '_ISpeechVoiceEvents',
    'SPAUDIOSTATE', 'SAFT44kHz8BitStereo', 'SAFT32kHz8BitMono',
    'SAFT48kHz8BitMono', 'SpeechPropertyResponseSpeed', 'ISpVoice',
    'SpeechGrammarRuleStateTransitionType', 'SREAllEvents',
    'DISPID_SWFEFormatTag', 'SPWF_SRENGINE', 'SPBO_AHEAD',
    'SREBookmark', 'DISPID_SGRsItem', 'DISPID_SREmulateRecognition',
    'SAFTADPCM_22kHzMono', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SDKOpenKey', 'DISPID_SGRAddState', 'ISpeechGrammarRules',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechRecoResultTimes',
    'SDTProperty', 'SAFTDefault', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechAudioStatus',
    'SPWORDLIST', 'ISpeechMMSysAudio', 'DISPID_SPILanguageId',
    ...
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCEPhraseStart',
    'DISPID_SOTSetId', '__MIDL_IWinTypes_0009', 'SGLexical',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCEAudioLevel', 'SFTInput',
    'SDTRule', 'SRAORetainAudio', 'SPPS_Noncontent',
    'SPSInterjection', 'SVEVoiceChange', 'SPSNotOverriden',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPRsItem',
    'SPDKL_CurrentConfig', 'SPEI_ADAPTATION', 'SRTAutopause',
    'ISpPhoneConverter', 'ISpeechLexicon', 'SP_VISEME_20',
    'DISPID_SpeechPhraseReplacement', 'ISpeechPhraseRule',
    'DISPID_SOTId', 'DISPID_SABufferNotifySize', 'SPSEMANTICFORMAT',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechPhraseElement',
    'DISPID_SVEAudioLevel', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPAStartElementInResult', 'SP_VISEME_3', 'SPCS_DISABLED',
    'SDTPronunciation', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPRuleConfidence',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPAPhraseInfo',
    'SRAONone', 'SPEI_WORD_BOUNDARY', 'SPEI_MAX_TTS',
    'DISPID_SGRSTType', 'SDTReplacement', 'SPSMF_UPS',
    'tagSPPROPERTYINFO', 'DISPID_SpeechObjectTokens',
    'DISPID_SDKSetStringValue', 'DISPID_SPCPhoneToId', 'SpFileStream',
    'DISPID_SOTs_NewEnum', 'SpeechRecoProfileProperties',
    'DISPID_SASCurrentDevicePosition', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SFSOpen', 'eWORDTYPE_DELETED', 'DISPID_SVSpeakStream',
    'SPVPRI_NORMAL', 'SRADynamic', 'DISPID_SPPChildren',
    'DISPID_SpeechGrammarRuleState', 'SPINTERFERENCE_LATENCY_WARNING',
    'SINone', 'ISpShortcut', 'DISPID_SAVolume', 'SPRST_INACTIVE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechLexiconWords',
    'DISPID_SRRSetTextFeedback', 'SPRECOCONTEXTSTATUS',
    'SPINTERFERENCE_TOOQUIET', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVSpeak', 'SpWaveFormatEx', 'SPPROPERTYINFO',
    'SPDKL_DefaultLocation', 'DISPID_SLPSymbolic', 'SP_VISEME_5',
    'SAFT22kHz8BitStereo', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCEEndStream', 'SPEI_START_INPUT_STREAM',
    'SPEI_END_INPUT_STREAM', 'SPBINARYGRAMMAR', 'eLEXTYPE_PRIVATE2',
    'SRAInterpreter', 'DISPID_SPPBRestorePhraseFromMemory', 'SVP_1',
    'DISPID_SPEActualConfidence', 'ISpXMLRecoResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT24kHz8BitStereo',
    'SAFTGSM610_22kHzMono', 'DISPID_SVEEnginePrivate',
    'SRSEIsSpeaking', 'SPXMLRESULTOPTIONS', 'SITooLoud',
    'DISPID_SASFreeBufferSpace', 'SECNormalConfidence',
    'Speech_Max_Pron_Length', 'DISPID_SRCResume', 'SpeechFormatType',
    'DISPID_SpeechLexicon', 'DISPID_SRAudioInputStream',
    'SAFT32kHz8BitStereo', 'SPPS_Interjection',
    'DISPID_SRSClsidEngine', 'SPAS_STOP', 'SAFTExtendedAudioFormat',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRRTTickCount',
    'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFVoiceMask',
    'SpMMAudioEnum', 'DISPID_SGRId', 'SRSActive', 'SPBOOKMARKOPTIONS',
    'DISPID_SMSADeviceId', 'DISPID_SpeechRecoContextEvents',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SpeechObjectToken',
    'DISPID_SABIBufferSize', 'DISPID_SLPLangId', 'SPVPRI_OVER',
    'SPRECORESULTTIMES', 'SpeechPropertyAdaptationOn',
    'eLEXTYPE_RESERVED10', 'DISPID_SRCreateRecoContext',
    'SPSTREAMFORMATTYPE', 'DISPID_SRRTOffsetFromStart',
    'SRCS_Disabled', 'ISpSerializeState', 'SpCompressedLexicon',
    'SRERecognition', 'DISPID_SPPFirstElement', 'DISPID_SpeechAudio',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPRText', 'DISPID_SVSpeakCompleteEvent', 'SPLOADOPTIONS',
    'SAFTADPCM_8kHzStereo', 'ISpRecoCategory',
    'DISPID_SRCRequestedUIType', 'SGDSInactive', 'DISPID_SVRate',
    'SDKLCurrentUser', 'SpeechGrammarTagDictation', 'SPLO_DYNAMIC',
    'eLEXTYPE_PRIVATE20', 'SDTDisplayText', 'SPAS_CLOSED',
    'SpeechPropertyResourceUsage', 'SpeechStreamFileMode',
    'SVSFIsXML', 'DISPID_SABufferInfo', 'DISPID_SPRuleParent',
    'DISPID_SPRulesCount', 'eWORDTYPE_ADDED',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRGCommit',
    'SPPS_RESERVED1', 'DISPID_SVDisplayUI',
    'DISPID_SLAddPronunciation', 'DISPID_SRSCurrentStreamPosition',
    'ISpRecognizer3', 'SVSFParseAutodetect', 'SDTAlternates',
    'eLEXTYPE_PRIVATE9', 'SGSExclusive', 'ISpeechBaseStream',
    'Speech_StreamPos_RealTime', 'SVP_15', 'SWTAdded',
    'SGDSActiveUserDelimited', 'SAFT11kHz16BitMono', 'SVP_8',
    'DISPID_SBSRead', 'DISPID_SVSRunningState', 'DISPID_SVEWord',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPPEngineConfidence',
    'SGRSTTDictation', 'DISPID_SRSSupportedLanguages',
    'eLEXTYPE_PRIVATE7', 'SSTTDictation', 'SVSFNLPSpeakPunc',
    'DISPID_SMSAMMHandle', 'SpeechAllElements', 'DISPID_SPIEngineId',
    'DISPID_SRGetFormat', 'SpeechWordPronounceable',
    'SDKLDefaultLocation', 'DISPID_SRGRecoContext', 'SRATopLevel',
    'SPEVENTSOURCEINFO', 'DISPID_SGRSTWeight',
    'DISPID_SRRSaveToMemory', 'SPCONTEXTSTATE', 'SP_VISEME_1',
    'DISPID_SGRsFindRule', 'SRSActiveAlways', 'DISPID_SPIRule',
    'SpeechTokenKeyFiles', 'DISPID_SpeechGrammarRule', 'SPRS_ACTIVE',
    'DISPID_SpeechAudioFormat', 'SITooFast', 'SpeechAudioVolume',
    'DISPID_SpeechPhraseReplacements', 'SpeechRegistryUserRoot',
    'SpPhoneticAlphabetConverter', 'SAFT8kHz8BitMono',
    'DISPID_SOTCreateInstance', 'STSF_FlagCreate',
    'SpeechRuleAttributes', 'SpeechVoiceEvents', 'SVSFPersistXML',
    'SVP_16', 'ISpStream', 'SAFTADPCM_11kHzStereo',
    'SPDATAKEYLOCATION', 'DISPID_SLWType', 'SECFDefault',
    'DISPID_SVIsUISupported', 'DISPID_SVSLastResult',
    'DISPID_SLGenerationId', 'SAFT48kHz16BitMono',
    'eLEXTYPE_RESERVED6', 'SPEI_FALSE_RECOGNITION', 'SPEI_MIN_TTS',
    ...
    'eLEXTYPE_MORPHOLOGY', 'SPLEXICONTYPE', 'ISpNotifySource',
    'IStream', 'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SDKCreateKey',
    'SPPS_NotOverriden', 'SP_VISEME_15', 'SpShortcut',
    'SGPronounciation', 'DISPID_SVEStreamStart', 'SPRST_NUM_STATES',
    'SVEEndInputStream', 'SpeechCategoryRecognizers',
    'SAFTGSM610_8kHzMono', 'SAFT8kHz8BitStereo', 'SVSFParseMask',
    'SGDSActive', 'SPEI_SR_PRIVATE', 'ISpeechXMLRecoResult',
    'SPSSuppressWord', 'DISPID_SpeechLexiconProns', 'SSFMCreate',
    'SGSEnabled', 'ISpEventSink', 'SPWAVEFORMATTYPE',
    'SpeechTokenKeyAttributes', 'ISpRecognizer2', 'DISPID_SPRsCount',
    'STCLocalServer', 'SPDKL_LocalMachine', 'ISpAudio',
    'SAFT12kHz8BitStereo', 'SVEBookmark', 'DISPID_SGRSTPropertyId',
    'eLEXTYPE_PRIVATE14', 'DISPID_SpeechPhraseProperty',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFT8kHz16BitStereo',
    'ISpRecoContext2', 'DISPID_SWFEBlockAlign',
    'ISpStreamFormatConverter', 'SPAR_Unknown', 'eLEXTYPE_PRIVATE1',
    'SAFT12kHz16BitMono', 'SpSharedRecoContext',
    'DISPID_SpeechPhraseProperties', 'DISPID_SOTGetDescription',
    'ISpeechPhoneConverter', 'DISPID_SOTCId', 'SAFTADPCM_8kHzMono',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPIAudioSizeBytes',
    'ISpPhoneticAlphabetConverter', 'DISPID_SpeechBaseStream',
    'DISPID_SABIMinNotification', 'SDTAll', 'SPADAPTATIONRELEVANCE',
    'SpMMAudioOut', 'UINT_PTR', 'DISPID_SDKEnumKeys',
    'ISpeechPhraseInfoBuilder', 'DISPID_SBSSeek',
    'SpNotifyTranslator', 'SPEI_RESERVED3', 'SVP_20', 'WAVEFORMATEX',
    'ISpeechMemoryStream', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT11kHz16BitStereo', 'SpeechPartOfSpeech',
    'ISpeechRecoResultDispatch', 'SREPrivate',
    'DISPID_SRIsUISupported', '_SPAUDIOSTATE',
    ...
    'SGRSTTRule', 'DISPID_SRCEHypothesis',
    'DISPID_SRGetPropertyNumber', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SVAlertBoundary', 'SREStreamEnd',
    'DISPID_SVSLastBookmarkId', 'eLEXTYPE_PRIVATE3',
    'SPCT_SUB_DICTATION', 'SPAUDIOOPTIONS', 'DISPID_SPPsCount',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGCmdLoadFromMemory',
    'SPSHT_OTHER', 'SpTextSelectionInformation',
    'DISPID_SPARecoResult', 'SPEI_START_SR_STREAM',
    'DISPID_SPCIdToPhone', 'SVP_5', 'SPGS_EXCLUSIVE',
    'SPBO_TIME_UNITS', 'SPEI_SR_BOOKMARK', 'SpeechLexiconType',
    'eLEXTYPE_PRIVATE15', 'DISPID_SCSBaseStream', 'SVP_0',
    'ISpeechRecognizer', 'DISPID_SDKDeleteValue',
    'SpPhraseInfoBuilder', 'DISPID_SRGSetWordSequenceData',
    'SPWORDPRONUNCIATION', 'DISPID_SpeechVoiceEvent',
    'SAFT8kHz16BitMono', 'SVSFParseSapi', 'SpAudioFormat',
    'SpeechAudioProperties', 'eLEXTYPE_USER', 'DISPID_SPPName',
    'SpeechPropertyLowConfidenceThreshold', 'SVP_12',
    'eLEXTYPE_PRIVATE19', 'ISpeechDataKey',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVResume', 'SVP_13',
    '_ISpeechRecoContextEvents', 'DISPID_SOTsItem',
    'SpeechCategoryVoices', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseElements', 'SPEI_MIN_SR',
    'DISPID_SDKSetLongValue', 'ISpeechWaveFormatEx', 'SpeechRunState',
    'tagSTATSTG', 'SPFM_CREATE_ALWAYS', 'eLEXTYPE_PRIVATE4',
    'SPCS_ENABLED', 'ISpeechPhraseRules',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPPS_Noun',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechRecoResult2',
    'ISpeechObjectToken', 'DISPID_SpeechPhoneConverter',
    'ISpResourceManager', 'DISPID_SAFType', 'SP_VISEME_2', 'SVP_11',
    'SPINTERFERENCE_TOOLOUD', 'SVEViseme', 'SVEAudioLevel', 'SBONone',
    'DISPID_SRCERecognition', 'SpeechAudioState', 'DISPID_SRGId',
    'DISPID_SRGetRecognizers', 'SP_VISEME_14', 'SPRULESTATE',
    'ISpeechPhraseReplacement', 'SGRSTTEpsilon', 'SpeechUserTraining',
    'ISpGrammarBuilder', 'SPAS_RUN', 'SPPHRASEREPLACEMENT',
    'DISPID_SOTCSetId', 'DISPID_SRCEventInterests',
    'DISPID_SpeechPhraseInfo', 'STSF_LocalAppData',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_RESERVED7',
    'SpInprocRecognizer', 'SPSModifier', 'SAFT44kHz16BitMono',
    'ISpEventSource', 'SPGS_DISABLED', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPEAudioSizeTime', 'SREInterference',
    'ISpeechPhraseElements', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRGRules', 'DISPID_SOTsCount', 'SPVPRIORITY',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRGSetTextSelection',
    'SPAR_Medium', 'SpeechVoiceSkipTypeSentence', 'SECHighConfidence',
    'SPWORDPRONOUNCEABLE', 'eLEXTYPE_PRIVATE6', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRCState', 'DISPID_SVSkip', 'SpeechVisemeType',
    'SP_VISEME_19', 'SPSHORTCUTPAIRLIST', 'SPEI_PHRASE_START',
    'DISPID_SRGCmdLoadFromFile', 'SpStreamFormatConverter',
    'eLEXTYPE_USER_SHORTCUT', 'SPRST_ACTIVE', 'STCRemoteServer',
    'SPWORD', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechAudioStatus',
    'DISPID_SRCCreateGrammar', 'SRESoundEnd', 'SGRSTTTextBuffer',
    'eLEXTYPE_PRIVATE17', 'ISpeechPhraseAlternates', 'SRESoundStart',
    'SPSHORTCUTTYPE', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechLexiconWord', 'IInternetSecurityManager',
    'SDA_One_Trailing_Space', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCESoundEnd', 'SPPHRASE', 'SINoSignal',
    'SPFM_OPEN_READONLY', 'DISPID_SRCPause', 'SITooSlow',
    'DISPID_SPIAudioSizeTime', 'SAFT24kHz8BitMono',
    'SpeechRecoContextState', 'SpeechInterference',
    'DISPID_SMSGetData', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechRecognizer', 'SPEI_END_SR_STREAM',
    'Speech_Max_Word_Length', 'DISPID_SGRsCommit', 'SECFIgnoreCase',
    'DISPID_SGRsDynamic', '_RemotableHandle', 'DISPID_SLPs_NewEnum',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRSAudioStatus',
    'SPAO_NONE', 'SVF_Emphasis', 'SPSLMA', 'DISPID_SGRSTText',
    'SPLO_STATIC', 'DISPID_SPCLangId', 'DISPID_SRCEEnginePrivate',
    'SVSFDefault', 'SP_VISEME_10', 'DISPID_SRCEStartStream',
    'SpeechGrammarWordType', 'SAFT24kHz16BitMono', 'SVP_21',
    'SAFTNoAssignedFormat', 'SVP_4', 'DISPID_SPIGetText',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SGRsCommitAndSave',
    'SREPropertyStringChange', 'SpeechRuleState',
    'DISPID_SpeechMemoryStream', 'SPINTERFERENCE_TOOFAST',
    'SVEStartInputStream', 'SAFTADPCM_11kHzMono', 'SRCS_Enabled',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SPIRetainedSizeBytes', 'eLEXTYPE_PRIVATE12',
    'STCInprocServer', 'DISPID_SGRs_NewEnum', 'SPRS_INACTIVE',
    'SAFT44kHz16BitStereo', 'DISPID_SLWs_NewEnum', 'DISPID_SGRClear',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVSInputWordPosition',
    'DISPID_SVWaitUntilDone', 'STCAll', 'DISPID_SVEVoiceChange',
    'SAFT22kHz8BitMono', 'SVP_3', 'DISPID_SBSFormat',
    'SpeechCategoryPhoneConverters', 'SLODynamic',
    'SpeechRecognizerState', 'eLEXTYPE_PRIVATE8',
    'SpeechTokenShellFolder', 'DISPID_SRGIsPronounceable',
    'DISPID_SASetState', 'SPPS_SuppressWord',
    'DISPID_SPEEngineConfidence', 'SPCT_SLEEP',
    'SAFT32kHz16BitStereo', 'SPRULE',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVESentenceBoundary',
    'SPSUnknown', 'DISPID_SLGetPronunciations',
    'DISPID_SLAddPronunciationByPhoneIds', 'SREPhraseStart',
    'SPEI_INTERFERENCE', 'SPEI_RECOGNITION', 'SSFMCreateForWrite',
    'SWPUnknownWordPronounceable', 'DISPID_SPIReplacements',
    'DISPID_SWFEExtraData', 'SDTLexicalForm', 'eLEXTYPE_RESERVED4',
    'DISPID_SLPsItem', 'DISPID_SPEAudioTimeOffset',
    'SpeechEmulationCompareFlags', 'SAFT12kHz16BitStereo',
    'SpeechGrammarTagWildcard', 'SVP_6', 'DISPID_SRGReset',
    'DISPID_SGRName', 'SpeechGrammarState',
    'DISPID_SPRuleFirstElement', 'DISPID_SGRSTsItem',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPERequiredConfidence',
    'ISpProperties', 'SVP_9', 'DISPID_SRRecognizer',
    'SpeechEngineConfidence', 'DISPID_SAFGetWaveFormatEx',
    'SPPS_RESERVED4', 'SECFIgnoreWidth', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SAEventHandle', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPIElements', 'ISpeechAudioBufferInfo', 'SPVPRI_ALERT',
    'SPGRAMMARWORDTYPE', 'SPGRAMMARSTATE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SBOPause', 'DISPIDSPTSI',
    'DISPID_SVGetProfiles', 'SpeechWordType', 'ISpeechFileStream',
    'SP_VISEME_18', 'SP_VISEME_0', 'DISPID_SGRSAddWordTransition',
    'DISPID_SPEsItem', 'DISPID_SRGCmdSetRuleIdState',
    'SRTExtendableParse', 'SGRSTTWildcard', 'SSTTTextBuffer',
    'SDKLCurrentConfig', 'Speech_StreamPos_Asap', 'SVP_2',
    'SP_VISEME_7', 'SAFT48kHz16BitStereo', 'SP_VISEME_13',
    'DISPID_SPANumberOfElementsInResult', 'SPPHRASEPROPERTY',
    'SpeechRecoEvents', 'SPEI_UNDEFINED', 'SRAExport',
    'SPEI_SOUND_START', 'SREAudioLevel', 'SAFT22kHz16BitMono',
    'DISPID_SpeechPhraseRule', 'SVP_18', 'SDA_Consume_Leading_Spaces',
    ...
    'SAFT16kHz8BitStereo', 'SpeechTokenKeyUI',
    'DISPID_SRRTStreamTime', 'ISpObjectWithToken', 'ISpNotifySink',
    'DISPID_SDKEnumValues', 'DISPID_SPRs_NewEnum', 'SVP_19',
    'SpUnCompressedLexicon', 'ISpeechGrammarRuleState',
    'DISPID_SPRulesItem', 'SPSMF_SAPI_PROPERTIES',
    'SpeechEngineProperties', 'ISpeechRecoResult',
    'DISPID_SWFEAvgBytesPerSec', 'ISequentialStream',
    'DISPID_SVSInputWordLength', 'SPEI_RECO_STATE_CHANGE',
    'SPSERIALIZEDRESULT', 'SINoise',
    'SpeechPropertyComplexResponseSpeed', 'SPDKL_CurrentUser',
    'DISPID_SDKSetBinaryValue', 'SPCT_COMMAND', 'SITooQuiet',
    'SpeechDisplayAttributes', 'SpeechGrammarTagUnlimitedDictation',
    'SPPHRASEELEMENT', 'SpeechPropertyNormalConfidenceThreshold',
    'SAFTCCITT_ALaw_44kHzMono', 'SPAS_PAUSE', 'SPPS_LMA',
    'DISPID_SpeechVoice', 'DISPID_SPPValue', 'SP_VISEME_6',
    'DISPID_SRRRecoContext', 'ISpeechPhraseReplacements',
    'SAFT44kHz8BitMono', 'DISPID_SRCRecognizer', 'SRADefaultToActive',
    'DISPID_SVEStreamEnd', 'SP_VISEME_11', 'ISpRecoResult',
    'DISPID_SDKGetlongValue', 'SASStop', 'DISPID_SPEsCount',
    'SAFTCCITT_ALaw_8kHzMono', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPIGrammarId', 'SpLexicon'
]

_check_version('1.2.0', 1696989488.904343)
